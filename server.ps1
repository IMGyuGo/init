...
Menu:
  all                    # start/stop infra, API, frontend, worker
  infra                  # start/stop local Docker infra
  backend/api            # start/stop API
  frontend               # start/stop frontend
  worker                 # start/stop worker
  prisma                 # open generate/migrate/seed submenu

Keys:
  ↑/↓                    # move
  Enter                  # run/open/toggle
  r                      # refresh status
  q                      # quit
'@
      return
